...
| 要動的檔 / 範疇 | 動工前讀 |
|---|---|
| m2_campaign.gd / 戰鬥流邏輯 | docs/遊戲核心系統機制.md, docs/開發里程碑.md M2 |
| adventure_journal | docs/戰鬥紀錄系統設計.md |
| hub | docs/UI 設計指引.md §3.11, §3.12 |
| 整備節點 / supply | docs/程式規格書.md §3.14 |
| 卡牌 | docs/卡牌設計原則.md |
| 敵人 | docs/敵人設計原則.md |
| 戰鬥介面版型 | docs/第一期 UI 線框圖.md |
